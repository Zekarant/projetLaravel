...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        @isset($category)
                {{ currentRoute(route('matiere', $category->slug)) }}
                @endisset
            ...
            @auth
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle{{ currentRoute(route('cours.create'))}}"
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownGestAlbum">
                        <a class="dropdown-item" href="{{ route('cours.create') }}">
                            <i class="fas fa-images fa-lg"></i> @lang('Ajouter un cours')
                        </a>
                    </div>
                </li>
            @endauth
